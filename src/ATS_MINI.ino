...
#define BATT_ADC_FACTOR      1.787  // ADC correction factor used for the battery monitor
...
*/
Band band[] = {
    {"VHF2", FM_BAND_TYPE, 8750, 10800, 10070, 1, 0},
    {"VHF1", FM_BAND_TYPE, 6400, 8750, 7208, 1, 0},
